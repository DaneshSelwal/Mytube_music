...
## 2024-05-19 - Regex matching inside hot loop parsing
**Learning:** Parsing LRC lyrics files using Regex is significantly slower and generates excessive object allocations.
**Action:** Replace `Regex` with manual character index parsing and mathematical conversion when parsing strict patterns like timestamp formats in a loop.
