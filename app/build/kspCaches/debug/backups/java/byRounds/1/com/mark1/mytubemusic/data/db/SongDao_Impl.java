...
public final class SongDao_Impl implements SongDao {
  ...
  public SongDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfSong = new EntityInsertionAdapter<Song>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `songs` (`uri`,`title`,`artist`,`album`,`duration`,`isFavorite`) VALUES (?,?,?,?,?,?)";
      }
    ...
    this.__preparedStmtOfUpdateFavorite = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "UPDATE songs SET isFavorite = ? WHERE uri = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object updateFavorite(final String uri, final boolean isFavorite,
      ...
      public List<Song> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Song(_tmpUri,_tmpTitle,_tmpArtist,_tmpAlbum,_tmpDuration,_tmpIsFavorite);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object deleteSongsNotIn(final List<String> uris,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        ...
        _stringBuilder.append("DELETE FROM songs WHERE uri NOT IN (");
